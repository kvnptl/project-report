...
\begin{document}
    ...
    \section{Challenges and Difficulties}
        ...
        \textbf{General Guidelines for Network Architecture}: As identified by Feng et al. \cite{feng2020deep}, there is an absence of a universally accepted framework or guidelines for designing network architectures in multimodal sensor fusion. This leads to unanswered questions regarding the optimal choices for 'what to fuse' (e.g., LiDAR, radar, various camera types), 'how to fuse' (such as through addition, concatenation, or more complex methods), and 'when to fuse' (determining at which stage of the processing to integrate the different modalities).
