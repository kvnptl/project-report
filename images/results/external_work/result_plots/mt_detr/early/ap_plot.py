...
# Plot the trendline
plt.plot(x_values, p(x_values), "k--", linewidth=2, label="Trend (C+L+R)")
...
plt.grid(True)
plt.title('MT-DETR Early Fusion across modalities: Average Precision (AP) by weather conditions')
